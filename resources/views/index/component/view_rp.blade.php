<style>
    /* RESPONSIVE VIEW */
    .shin_md_rp__open, .shin_md_rp__close{ position: fixed; left: 40px; bottom: 40px; width: 40px; height: 40px; display: none; color: white; background-color: rgb(237, 157, 38); align-items: center; justify-content: center; border-radius: 4px; }
    ...
    .shin_sm_rp__open, .shin_sm_rp__close{ position: fixed; left: 40px; bottom: 100px; width: 40px; height: 40px; display: none; color: white; background-color: #4cca5e; align-items: center; justify-content: center; border-radius: 4px; }
